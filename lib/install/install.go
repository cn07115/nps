...
func fetchLatestVersion() (string, error) {
	resp, err := http.Get("https://api.github.com/repos/cn07115/nps/releases/latest")
	if err != nil {
		return "", err
	}
...
func downloadLatest(bin string) string {
	// get version
	data, err := http.Get("https://api.github.com/repos/cn07115/nps/releases/latest")
	if err != nil {
		log.Fatal(err.Error())
	}
	...
	downloadUrl := fmt.Sprintf("https://github.com/cn07115/nps/releases/download/%s/%s", version, filename)
